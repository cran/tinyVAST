...
#'        \code{palpha1_g} is the first predictor from fixed covariates in \code{formula},
#'        \code{pgamma1_g} is the first predictor from random covariates in \code{formula} (e.g., splines),
#'        \code{pomega1_g} is the first predictor from spatial variation,
#'        \code{pepsilon1_g} is the first predictor from spatio-temporal variation,
#'        \code{pxi1_g} is the first predictor from spatially varying coefficients,
