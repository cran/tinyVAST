...
`tinyVAST` includes features to fit a dynamic structural equation model [@thorson_dynamic_2024].  We here show this using a bivariate vector autoregressive model for wolf and moose abundance on Isle Royale.
